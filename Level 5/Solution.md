## Concept 
Let us Understand how the Division Takes place in by `Div` Instruction in our Assembly

I will Explain this in context to our Challenge , We have 3 Registers 
...
```sh
hacker@assembly-crash-course~level5:~$ /challenge/run
...
rocess = pwn.process("/challenge/run")
process.write(code)
